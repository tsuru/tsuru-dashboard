  ...
  render: function() {
    return (
      React.createElement("div", {className: "template"}, 
        React.createElement("label", null, "Template: ", React.createElement("select", null))
      )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {className: "register"}, 
        React.createElement("label", null, "Register an already created node: ", React.createElement("input", {type: "checkbox"}))
      )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {className: "meta-item"}, 
        React.createElement("label", null, "Key: ", React.createElement("input", {type: "text"})), 
        React.createElement("label", null, "Value: ", React.createElement("input", {type: "text"}))
      )
    );
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {className: "node-create"}, 
        ...
        React.createElement(Register, {register: this.state.register}), 
...
},{"../components/node-create.jsx":1,"react":161,"react-dom":5}],3:[function(require,module,exports){
