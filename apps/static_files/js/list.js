...
var AppTable = React.createClass({displayName: "AppTable",
  render: function() {
    var appNodes = this.props.data.apps.map(function(app) {
      return (
        React.createElement(App, {name: app.name, url: app.url})
      );
    });
    return (
  ...
  render: function() {
    return (
      React.createElement("div", {className: "app-list"}, 
        React.createElement(AppSearch, {onSearchSubmit: this.handleSearchSubmit}), 
        React.createElement(AppTable, {data: this.state.data})
      )
    );
  }
});
...
},{"../components/list.jsx":1,"react":158}],3:[function(require,module,exports){
